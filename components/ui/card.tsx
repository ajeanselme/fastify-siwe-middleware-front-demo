...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-xs font-medium font-mono text-muted-foreground uppercase group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-4 text-sm text-muted-foreground group-data-[size=sm]/card:px-3", className)}
      {...props}
    />
  )
}
